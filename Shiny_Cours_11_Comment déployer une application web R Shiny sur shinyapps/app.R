...
ui <- fluidPage(
  # theme = shinytheme("flatly"), # Pour injecter de couleur sur les pages
  shinythemes::themeSelector(), # Pour choisir le theme prefere sur les pages
  h1("2eme Application iris"),
  h3("infos sur l'auteur"),
  tags$a("Ma page Github", href = "https://github.com/HecGibsonK"),
  tags$a("Ma page Google Sholar", href = "https://scholar.google.com/citations?hl=ru&user=EMCJgM0AAAAJ&view_op=list_works&sortby=pubdate"),
